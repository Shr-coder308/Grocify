       ...
       <section>
        <div className="max-w-[1400px] mx-auto px-10 py-20">
            ...
            <div className="flex justify-end mt-5 py-5 gap-x-3">
                <button className="custom-prev text-2xl rounded-lg w-11 h-11 bg-zinc-100 flex justify-center items-center text-zinc-800 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 cursor-pointer">
                      
                      <IoIosArrowBack/>
                </button>
                 <button className="custom-next text-2xl rounded-lg w-11 h-11 bg-zinc-100 flex justify-center items-center text-zinc-800 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 cursor-pointer" >
                    <IoIosArrowForward />
            ...
            review.map(item=>{
                ...
                <div className="flex gap-5 items-center">
                        ...
                        <div>
                            ...
                            <span className="flex gap-1 text-yellow-400 mt-2 text-xl">
